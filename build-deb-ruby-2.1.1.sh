#!/bin/sh
# Built on Ubuntu saucy.
version=2.1.1
rubyversion=$version
rubysrc=ruby-$rubyversion.tar.bz2
checksum=53edc33b2f590ecdd9f6a344b9d92d0d
destdir=/tmp/install-$rubyversion

apt-get -y install build-essential bzip2 wget libssl-dev libreadline-dev zlib1g-dev libyaml-dev libgdbm-dev libffi-dev libncurses5-dev libxml2-dev libxslt1-dev automake libtool ruby1.9.1 ruby1.9.1-dev libc6-dev
